    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndustryProject", x => new { x.IndustriesId, x.ProjectsId });
                    table.ForeignKey(
                        name: "FK_IndustryProject_Industries_IndustriesId",
                        column: x => x.IndustriesId,
                        principalTable: "Industries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IndustryProject_Projects_ProjectsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndustryUser", x => new { x.IndustriesId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_IndustryUser_Industries_IndustriesId",
                        column: x => x.IndustriesId,
                        principalTable: "Industries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IndustryUser_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timepoints_Topics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndustryProject_ProjectsId",
                table: "IndustryProject",
                column: "ProjectsId");

            migrationBuilder.CreateIndex(
                name: "IX_IndustryUser_UsersId",
                table: "IndustryUser",
                column: "UsersId");
